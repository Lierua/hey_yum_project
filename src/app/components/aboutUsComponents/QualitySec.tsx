...
const QualitySec = () => {
  return (
    ...
    >
      ...
      <div className="md:mt-[50%] overflow-hidden">
      ...
      <div className="max-h-[700px]">
        <TextBox header="Member of organic Denmark">
          <p>As a member of Organic Denmark, we support an organization that has been transforming the organic sector for nearly 35 years. Organic Denmark is a pioneering lobbyist working to shape policies that drive organic market growth and turn the food sector into a catalyst for green development.</p>
          <p>Recognized by the UN Future Policy Award in 2018, they have helped Denmark become a world leader in organic agriculture, with goals like introducing 60 percent organic food in public kitchens and integrating organic farming into climate and biodiversity strategies. At Sweet Intentions, we are committed to a vision of food production that gives more back to our planet than it takes—protecting nature, water, and ensuring animals live good, natural lives.</p>
          <p>Our membership in Organic Denmark is a commitment to a healthier planet, happier animals, and more fertile soil</p>
